...
//   }
//
//   await page.locator(".title").nth(4).toHaveText("Apply Coupon");
//   await page.locator(".ng-untouched").fill("rahulshettyacademy");
...
test('@Webst Client App login', async ({ page }) => {
  ...
  const email = "edo3tanya@gmail.com";
  const productName = 'ZARA COAT 3';
  const products = page.locator(".card-body");
  await page.goto("https://rahulshettyacademy.com/client");
  await page.locator("#userEmail").fill(email);
  await page.locator("#userPassword").fill("Testing@2003");
  await page.locator("[value='Login']").click();
  await page.waitForLoadState('networkidle');
  ...
  await page.locator("tbody").waitFor(); //waiting for table to load
